      ...
      <main class="col-md-9 p-4">
        ...
        <?php else: ?>
          <?php foreach ($pedidos as $p): ?>
            ...
            $tieneCupon = !empty($p['Cupon_codigo']) && (float)$p['Descuento'] > 0;
            ?>
            <div class="card mb-2">
              <div class="card-body d-flex justify-content-between">
                ...
                <div class="text-end">
                  ...
                  <?php if ($tieneCupon): ?>
                    <div class="small">Cupón: <strong><?php echo htmlspecialchars($p['Cupon_codigo']); ?></strong> (−₡<?php echo number_format($p['Descuento'], 0); ?>)</div>
                  <?php endif; ?>
