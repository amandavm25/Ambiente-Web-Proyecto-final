        ...
        <div class="row g-3 mb-4">
          <div class="col-md-3">
            <div class="stat">
              ...
              <div class="value"><?php echo $pend; ?></div>
            </div>
          </div>
          <div class="col-md-3">
            <div class="stat">
              <div class="label">En preparación</div>
              <div class="value"><?php echo $prep; ?></div>
            </div>
          </div>
          <div class="col-md-3">
            <div class="stat">
              <div class="label">Listos</div>
              <div class="value"><?php echo $listo; ?></div>
            </div>
          </div>
          <div class="col-md-3">
            <div class="stat">
              <div class="label">Pedidos hoy</div>
              <div class="value"><?php echo $hoy; ?></div>
            </div>
          </div>
        </div>
            ...
            <div class="card mb-2">
              <div class="card-body d-flex justify-content-between">
                <div>#<?php echo $p['Id_pedido']; ?> - <?php echo htmlspecialchars($p['Cliente']); ?>
                  <br><small><?php echo $p['Fecha']; ?></small>
                </div>
                <div>
